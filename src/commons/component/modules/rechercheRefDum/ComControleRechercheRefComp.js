...
import * as Constants from '../../../../modules/controle/rechercheDum/state/controleRechercheRefDumConstants';
import * as RechecheDumAction from '../../../../modules/controle/rechercheDum/state/actions/controleRechercheRefDumAction';
...
const mapStateToProps = (state) => ({...state.controleRechercheRefDumReducer});
