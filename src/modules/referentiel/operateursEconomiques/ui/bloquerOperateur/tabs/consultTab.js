        ...
        return (
            <View>
                ...
                {this.props.detailMode && (
                    <RefOperateursEconomiquesCoreComponent navigation={this.props.navigation} mode={'consult'} blocageVo={this.props.data.detail} onReset={this.reset}/>
                )}
            </View>
        );
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(ConsultTab);
