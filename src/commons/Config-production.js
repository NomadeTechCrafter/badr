...
module.exports = {
  HOST: 'badr.douane.gov.ma',
  HOST_BO: 'bomobile.douane.gov.ma',
  BASE_SERVER_URL: 'https://badr.douane.gov.ma/badr',
  BACK_OFFICE_BASE_URL: 'https://bomobile.douane.gov.ma/BadrMobile/api',
  ...
  USER_SKIP_VERIVICATION_VERSION: ['Z193731'],
