...
class DelivrerMLV extends React.Component {
    ...
    validerMainLevee = () => {
        ...
        var action = mlvValiderAction.validerMLV(
            {
    ...
    delivrerMainLevee = () => {
        var data = this.state.delivrerMainleveeVO;
        var action = mlvDelivrerAction.delivrerMLV(
            {
    ...
    buildApurementD17D20TableColumns = () => {
        return [
            {
                code: 'referenceEnregistrement',
                libelle: translate('newmlv.delivrerMainlevee.listeDeclarationsApurementD17D20.reference'),
                width: 290,
            },
            {
                code: 'dateCreation',
                libelle: translate('newmlv.delivrerMainlevee.listeDeclarationsApurementD17D20.dateCreation'),
                width: 290,
            },
            {
                code: 'numeroVersionCourante',
                libelle: translate('newmlv.delivrerMainlevee.listeDeclarationsApurementD17D20.numeroVersion'),
                width: 290,
            },
        ];
    };
            ...
            <View style={CustomStyleSheet.fullContainer}>
                ...
                <ComContainerComp
                    ...
                    <ComBadrCardBoxComp style={styles.cardBox}>
                        <ComAccordionComp
                            title={translate(
                                'newmlv.delivrerMainlevee.annotations.title',
                            )}>
                            <Row style={CustomStyleSheet.whiteRow}>
                                <ComBadrLibelleComp withColor={false}>
                    ...
                    <ComBadrCardBoxComp style={styles.cardBox}>
                        <ComAccordionComp
                            title={translate(
                                'newmlv.delivrerMainlevee.motivations.title',
                            )}>
                            <Row style={CustomStyleSheet.whiteRow}>
                        ...
                        <ComAccordionComp
                            ...
                            <Grid>
                                <Row style={CustomStyleSheet.lightBlueRow} size={100}>
                                    <Col size={30}>
                                        <ComBadrLibelleComp withColor={true}>
                                            {translate('newmlv.delivrerMainlevee.conteneurs.conteneursCibles',)}
                                        </ComBadrLibelleComp>
                                    </Col>
                    ...
                    <ComBadrCardBoxComp noPadding={true}>
                        <ComAccordionComp
                            title={translate('newmlv.delivrerMainlevee.listeDeclarationsApurementD17D20.title')}>
                            <Grid>
                                <Row style={CustomStyleSheet.lightBlueRow} size={100}>
                                    <Col size={100}>
                                        <ComBasicDataTableComp
...
const mapStateToProps = (state) => ({...state.mlvDelivrerReducer});
