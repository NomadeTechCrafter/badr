...
class CreerCompteRenduMission extends React.Component {
        ...
        return (
            <View style={style.container}>
                <ComBadrToolbarComp
                    ...
                    icon="menu"
                    title={translate('enquetes.compteRenduMission.creerCompteRenduMission.title')}
                />

                {(this.props.searchMode) && (
                    <EnqCompteRenduSearchComponent navigation={this.props.navigation} mode={'add'}/>
                )}

                {this.props.detailMode && (
                    <EnqCompteRenduCoreComponent navigation={this.props.navigation} mode={'add'}
