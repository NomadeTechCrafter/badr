...
export default class EciDeclarationEnDetailBlock extends React.Component {
  ...
  render() {
    const {appositionScellesVO} = this.props;
    return (
        ...
        <ComAccordionComp
          ...
          <Grid>
            <Row style={CustomStyleSheet.lightBlueRow}>
              ...
              <Col>
                <ComBadrLibelleComp>
                  {appositionScellesVO.refDedServices.dateEnregistrement}
                </ComBadrLibelleComp>
              </Col>
              <Col>
                <ComBadrLibelleComp>
              ...
              <Col>
                <ComBadrLibelleComp>
                  {appositionScellesVO.refDedServices.poidsBruts}
                </ComBadrLibelleComp>
              </Col>
            </Row>
            <Row style={CustomStyleSheet.whiteRow}>
              ...
              <Col>
                <ComBadrLibelleComp>
                  {appositionScellesVO.refDedServices.libelleTypeDED}
                </ComBadrLibelleComp>
              </Col>
              <Col>
                <ComBadrLibelleComp>
              ...
              <Col>
                <ComBadrLibelleComp>
                  {appositionScellesVO.refDedServices.poidsNet}
                </ComBadrLibelleComp>
              </Col>
            </Row>
            <Row style={CustomStyleSheet.lightBlueRow}>
              ...
              <Col>
                <ComBadrLibelleComp>
                  {appositionScellesVO.refDedServices.operateurDeclarant}
                </ComBadrLibelleComp>
              </Col>
              <Col>
                <ComBadrLibelleComp>
              ...
              <Col>
                <ComBadrLibelleComp>
                  {appositionScellesVO.refDedServices.nombreContenants}
                </ComBadrLibelleComp>
              </Col>
            </Row>
            <Row style={CustomStyleSheet.whiteRow}>
              ...
              <Col size={1}>
                <ComBadrLibelleComp>
                  {appositionScellesVO.refDedServices.valeurDeclaree}
                </ComBadrLibelleComp>
              </Col>
              <Col size={2} />
            </Row>
