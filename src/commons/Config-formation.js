...
module.exports = {
  HOST: 'badr-formation.douane.gov.ma',
  HOST_BO: 'bomobile-formation.douane.gov.ma',
  BASE_SERVER_URL: 'https://badr-formation.douane.gov.ma/badr',
  BACK_OFFICE_BASE_URL: 'https://bomobile-formation.douane.gov.ma/BadrMobile/api',
  ...
  USER_SKIP_VERIVICATION_VERSION: ['FORMAG1', 'FORMAG2'],
