...
import * as Constants from '../../../../../common/constants/actifs/rapport/creation/entete';
import * as getOsById from '../../../../../redux/actions/actifs/rapport/creation/entete';
            ...
            <Grid>
              ...
              <Row style={CustomStyleSheet.whiteRow}>
                <Col size={this.props.consultation ? 5 : 15}>
                  <ComBadrLibelleComp>
                    {translate('actifs.entete.enteteTitleLeft')}
                ...
                <Col size={2}>
                  <ComBadrLibelleComp>
                    {this.props.consultation
                      ? translate('actifs.entete.enteteTitleRight') + '1'
                      : translate('actifs.entete.enteteTitleRight') + '0'}
                  </ComBadrLibelleComp>
                </Col>
              </Row>
              ...
              <Row style={CustomStyleSheet.whiteRow}>
                <Col size={3}>
                  <ComBadrLibelleComp withColor={true}>
                    {translate('actifs.entete.uniteOrganizationnelle')}
                  </ComBadrLibelleComp>
                </Col>
                <Col size={9}>
                  <TextInput
                ...
                <Col size={2} style={{padding: 5}}>
                  <ComBadrLibelleComp withColor={true}>
                    {translate('actifs.entete.journeeDu')}
                  </ComBadrLibelleComp>
                </Col>
                <Col size={4}>
                  <TextInput
              ...
              <Row style={CustomStyleSheet.whiteRow}>
                ...
                <Col size={1} style={{padding: 5}}>
                  <ComBadrLibelleComp withColor={true}>
                    {translate('actifs.entete.NumeroOrder')}
                  </ComBadrLibelleComp>
                </Col>
                <Col size={1}>
                  <TextInput
              ...
              <Row style={CustomStyleSheet.whiteRow}>
                <Col size={1}>
                  <Row>
                    <ComBadrLibelleComp withColor={true}>
                      {translate('actifs.entete.descriptionOS')}
                    </ComBadrLibelleComp>
                  </Row>
                </Col>
                <Col size={5}>
              ...
              <Row style={CustomStyleSheet.whiteRow}>
                <Col size={4}>
                  <ComBadrLibelleComp withColor={true}>
                    {translate('actifs.entete.dateDebut')}
                  </ComBadrLibelleComp>
                </Col>
                <Col size={4}>
                  <TextInput
                ...
                <Col size={2}>
                  <ComBadrLibelleComp withColor={true}>
                    {translate('actifs.entete.dateFin')}
                  </ComBadrLibelleComp>
                </Col>
                <Col size={4}>
                  <TextInput
              ...
              <Row style={CustomStyleSheet.whiteRow}>
                <Col size={3}>
                  <ComBadrLibelleComp withColor={true}>
                    {translate('actifs.entete.heureDebut')}
                  </ComBadrLibelleComp>
                </Col>
                <Col size={0.5} />
                <Col size={3}>
                ...
                <Col size={2} style={{paddingTop: 5}}>
                  <Text style={{fontSize: 12}}>
                    {translate('actifs.entete.uniteHeure')}
                  </Text>
                </Col>
                <Col size={5} />
                <Col size={2}>
                  <ComBadrLibelleComp withColor={true}>
                    {translate('actifs.entete.heureFin')}
                  </ComBadrLibelleComp>
                </Col>
                <Col size={3}>
                  <TextInput
