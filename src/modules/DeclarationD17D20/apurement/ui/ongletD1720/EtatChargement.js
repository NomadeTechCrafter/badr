...
//'../../../services/api/offline/controle/dataInitControle.json';
...
class EtatChargementScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...initialState,
    ...
    return [
      {
        ...
        libelle: translate('vuEmbarquee.etatChargement.ref'),
        width: 160,
      },
      {
      ...
      },
      {
        ...
        libelle: translate('vuEmbarquee.etatChargement.dateVoyage'),
        width: 150,
      },
      {
        code: 'dedServicesVO.poidsBruts',
        libelle: translate('vuEmbarquee.etatChargement.declarant'),
        width: 100,
      },
      {
        code: 'dedServicesVO.poidsNet',
        libelle: translate('vuEmbarquee.etatChargement.bureauSortie'),
        width: 100,
      },
      {
        code: 'dedServicesVO.valeurDeclaree',
        libelle: translate('vuEmbarquee.etatChargement.navire'),
        width: 100,
      },
    ];
  };
