...
class RechecheDum extends Component {
  ...
  render() {
    ...
    return (
      <Card
        style={[CustomStyleSheet.centerContainer, {flexDirection: 'column'}]}>
          ...
          <BadrErrorMessage
            message={[
              ...
              _.isEmpty(this.state.serie)
                ...
                : '',
              this.state.cle != this.state.cleValide
                ? translate('errors.cleNotValid', {cle: this.state.cleValide}) +
                  '\n'
                : '',
            ]}
          />
        ...
        <BadrTextInput
          ...
          onEndEditing={event =>
            this.onBlurInput({bureau: event.nativeEvent.text, maxLength: 3})
          }
        />
        <BadrTextInput
          maxLength={3}
          ...
          onEndEditing={event =>
            this.onBlurInput({regime: event.nativeEvent.text, maxLength: 3})
          }
        />
        <BadrTextInput
          maxLength={4}
          ...
          onEndEditing={event =>
            this.onBlurInput({annee: event.nativeEvent.text, maxLength: 4})
          }
        />
        <BadrTextInput
          maxLength={7}
          ...
          onEndEditing={event =>
            this.onBlurInput({serie: event.nativeEvent.text, maxLength: 7})
          }
        />
        <BadrTextInput
