...
class DelivrerMLV extends Component {
    ...
    render() {
        const {delivrerMainleveeVO, sousReservePaiementMLV} = this.state;
        return (
            <View style={CustomStyleSheet.fullContainer}>
                ...
                <Container>
                        ...
                        <Accordion
                            ...
                            <Grid>
                                ...
                                delivrerMainleveeVO.listeDocsExigibles.map((item, index) => (
                                    <Row key={index} style={ index%2 == 0 ? CustomStyleSheet.lightBlueRow: CustomStyleSheet.whiteRow} >
                                        <Col size={3}>
                    ...
                    <CardBox noPadding={true}>
                        <Accordion
                            title={translate(
                                'mainlevee.delivrerMainlevee.transit.title',
                            )}>
                            <Grid>
                                <Row style={CustomStyleSheet.lightBlueRow}>
                                    <Col size={1}>
