            ...
            <Container style={styles.container}>
                ...
                <View style={{flexDirection: 'row'}}>
                    ...
                    <TouchableRipple onPress={() => {
                        this.setState({sousReservePaiementMLV: !this.state.sousReservePaiementMLV});
                    }}>
                        <View style={styles.containerCheckbox}>
                            <View pointerEvents="none">
                                <Checkbox color={primaryColor}
                                          status={this.state.sousReservePaiementMLV ? 'checked' : 'unchecked'}/>
                            </View>
                            <Paragraph>{translate('mainlevee.sousReservePaiement')}</Paragraph>
                        </View>
                    </TouchableRipple>
                    <Button style={{width: 100}} icon="plus-box-outline" mode="text" compact={true}
                            onPress={() => this.props.navigation.navigate('ListDeclarationMLV')}>
                        Option
                    </Button>
