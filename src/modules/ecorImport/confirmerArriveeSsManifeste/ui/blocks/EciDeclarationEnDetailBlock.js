        ...
        <ComAccordionComp
          ...
          <Grid>
            <Row style={CustomStyleSheet.lightBlueRow}>
              ...
              <Col>
                <ComBadrLibelleComp>
                  {confirmerArriveeVO.refDedServices.dateEnregistrement}
                </ComBadrLibelleComp>
              </Col>
              <Col>
                <ComBadrLibelleComp>
              ...
              <Col>
                <ComBadrLibelleComp>
                  {confirmerArriveeVO.refDedServices.poidsBruts}
                </ComBadrLibelleComp>
              </Col>
            </Row>
            <Row style={CustomStyleSheet.whiteRow}>
              ...
              <Col>
                <ComBadrLibelleComp>
                  {confirmerArriveeVO.refDedServices.libelleTypeDED}
                </ComBadrLibelleComp>
              </Col>
              <Col>
                <ComBadrLibelleComp>
              ...
              <Col>
                <ComBadrLibelleComp>
                  {confirmerArriveeVO.refDedServices.poidsNet}
                </ComBadrLibelleComp>
              </Col>
            </Row>
            <Row style={CustomStyleSheet.lightBlueRow}>
              ...
              <Col>
                <ComBadrLibelleComp>
                  {confirmerArriveeVO.refDedServices.operateurDeclarant}
                </ComBadrLibelleComp>
              </Col>
              <Col>
                <ComBadrLibelleComp>
              ...
              <Col>
                <ComBadrLibelleComp>
                  {confirmerArriveeVO.refDedServices.nombreContenants}
                </ComBadrLibelleComp>
              </Col>
            </Row>
            <Row style={CustomStyleSheet.whiteRow}>
              ...
              <Col size={1}>
                <ComBadrLibelleComp>
                  {confirmerArriveeVO.refDedServices.valeurDeclaree}
                </ComBadrLibelleComp>
              </Col>
              <Col size={2} />
            </Row>
