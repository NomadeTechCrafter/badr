...
class SortiPortEtatChargement extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...initialState,
    ...
    return [
      {
        ...
        libelle: translate('sortiPort.etatChargement.ref'),
        width: 160,
      },
      {
      ...
      },
      {
        ...
        libelle: translate('sortiPort.etatChargement.dateVoyage'),
        width: 150,
      },
      {
        code: 'etatChargement.refDeclarant',
        libelle: translate('sortiPort.etatChargement.declarant'),
        width: 100,
      },
      {
        code: 'etatChargement.bureauSortie',
        libelle: translate('sortiPort.etatChargement.bureauSortie'),
        width: 100,
      },
      {
        code: 'etatChargement.navire',
        libelle: translate('sortiPort.etatChargement.navire'),
        width: 100,
      },
    ];
  };
