...
export default (state = initialState, action) => {
  ...
  switch (action.type) {
    case Constants.MAINLEVEE_CONFIRMER_REQUEST:
      ...
      return nextState;
    case Constants.MAINLEVEE_CONFIRMER_IN_PROGRESS:
      nextState.showProgress = true;
      return nextState;
    case Constants.MAINLEVEE_CONFIRMER_SUCCESS:
      nextState.errorMessage = null;
      ...
      return nextState;
    case Constants.MAINLEVEE_CONFIRMER_FAILED:
      nextState.showProgress = false;
