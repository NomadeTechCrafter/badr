...
class VerifierPContreEcorSsManifesteScreen extends Component {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    if (
      ...
      return {verifierCntEcorVO: dataAfterConfirmation.data};
    }
                      ...
                      <Row style={CustomStyleSheet.lightBlueRow}>
                        ...
                        <Col size={6}>
                          <ComBadrNumericTextInputComp
                            ...
                            mode={'outlined'}
                            disabled={true}
                            value={verifierCntEcorVO.bonSortie?.nombreColis}
                          />
                        </Col>
                      </Row>
                      <Row style={CustomStyleSheet.whiteRow}>
                        ...
                        <Col size={1}>
                          <TextInput
                            ...
                            style={styles.columnThree}
                            label=""
                            value={verifierCntEcorVO.bonSortie?.poidsNet}
                          />
                        </Col>
                        <Col size={1}>
                          <ComBadrLibelleComp withColor={true}>
                      ...
                      <Row style={CustomStyleSheet.lightBlueRow}>
                        ...
                        <Col size={6}>
                          <TextInput
                            ...
                            disabled={true}
                            label=""
                            value={verifierCntEcorVO.bonSortie?.dateHeureBS}
                            numberOfLines={6}
                          />
                        </Col>
                      </Row>
