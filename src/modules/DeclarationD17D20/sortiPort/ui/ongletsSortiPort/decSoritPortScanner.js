...
import style from '../../style/decSortiPortStyle';
...
import * as SortiPortScanAction from '../../state/actions/decSortiPortScanAction';
import * as Constants from '../../state/decSortiPortConstants';

class SortiPortScanner extends React.Component {
    defaultState = {
        selectedDum: {},
    };
    ...
    componentDidMount() {
        ...
        var action = SortiPortScanAction.request(
            {
...
function mapStateToProps(state) {
    return { ...state.sortiPortInitReducer };
}
