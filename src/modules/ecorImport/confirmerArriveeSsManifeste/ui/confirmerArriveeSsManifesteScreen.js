...
class ConfirmerArriveeSsManifesteScreen extends Component {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    if (
      ...
      return {confirmerArriveeVO: dataAfterConfirmation.data};
    }
                      ...
                      <Row style={CustomStyleSheet.lightBlueRow}>
                        ...
                        <Col size={6}>
                          <ComBadrNumericTextInputComp
                            ...
                            mode={'outlined'}
                            disabled={true}
                            value={confirmerArriveeVO.bonSortie?.nombreColis}
                          />
                        </Col>
                      </Row>
                      <Row style={CustomStyleSheet.whiteRow}>
                        ...
                        <Col size={1}>
                          <TextInput
                            ...
                            style={styles.columnThree}
                            label=""
                            value={confirmerArriveeVO.bonSortie?.poidsNet}
                          />
                        </Col>
                        <Col size={1}>
                          <ComBadrLibelleComp withColor={true}>
                      ...
                      <Row style={CustomStyleSheet.lightBlueRow}>
                        ...
                        <Col size={6}>
                          <TextInput
                            ...
                            disabled={true}
                            label=""
                            value={confirmerArriveeVO.bonSortie?.dateHeureBS}
                            numberOfLines={6}
                          />
                        </Col>
                      </Row>
                      ...
                      <Row style={CustomStyleSheet.whiteRow}>
                        <Col>
                          <ComBadrDatePickerComp
                            ...
                            readonly={false}
                            value={
                              confirmerArriveeVO.dateHeureAutorisationAcheminement
                                ? moment(
                                    confirmerArriveeVO.dateHeureAutorisationAcheminement?.split(' ')[0],
                                    'DD/MM/yyyy',
                                    true,
                                  )
                                : ''
                              ...
                              timeValue={
                                confirmerArriveeVO.dateHeureAutorisationAcheminement
                                ? moment(
                                      confirmerArriveeVO.dateHeureAutorisationAcheminement?.split(' ')[1],
                                    'HH:mm',
                                    true,
                                  )
                                : ''
                            ...
                            onDateChanged={(date) =>
                              this.setState({
                                ...
                                confirmerArriveeVO: {
                                  ...this.state.confirmerArriveeVO,
                                  dateHeureAutorisationAcheminement: date+' '+confirmerArriveeVO.dateHeureAutorisationAcheminement?.split(' ')[1]
                                },
                              })
                            }
                             onTimeChanged={(time) =>
                              this.setState({
                                ...
                                confirmerArriveeVO: {
                                  ...this.state.confirmerArriveeVO,
                                  dateHeureAutorisationAcheminement:confirmerArriveeVO.dateHeureAutorisationAcheminement?.split(' ')[0]+' ' +time,
                                },
                              })
                            }
                            labelDate={translate(
