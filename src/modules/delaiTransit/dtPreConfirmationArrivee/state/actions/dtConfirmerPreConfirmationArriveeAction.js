...
export function inProgress(action) {
  return {
    type: Constants.PRE_CONFIRMATION_ARRIVEE_IN_PROGRESS,
    value: action.value,
  };
}
...
export function success(data) {
  return {
    type: Constants.PRE_CONFIRMATION_ARRIVEE_SUCCESS,
    value: data
  };
}
...
export function failed(data) {
  return {
    type: Constants.PRE_CONFIRMATION_ARRIVEE_FAILED,
    value: data,
  };
}
...
export function init(action) {
  return {
    type: Constants.PRE_CONFIRMATION_ARRIVEE_INIT,
    value: action.value,
  };
}
export default {
