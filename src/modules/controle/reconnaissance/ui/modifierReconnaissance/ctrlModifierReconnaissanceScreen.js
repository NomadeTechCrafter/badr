...
class ModifierReconnaissance extends React.Component {
        ...
        return (
            <View style={style.container}>
                ...
                {this.props.detailMode && (
                    <CtrlReconnaissanceCoreComponent navigation={this.props.navigation} mode={'edit'} reconnaissanceVo={this.props.data.detail}/>
                )}
            </View>
        );
    };
