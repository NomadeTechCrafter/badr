...
class CtrlControleApresScannerCoreComponent extends React.Component {
    ...
    prepareState = () => {
        ...
        let photosControleApresScanner = this.props.controleApresScannerVo.photosControleApresScanner ? this.props.controleApresScannerVo.photosControleApresScanner : [];
    ...
    addScelle = () => {
        if (this.state.scelleVo.reference && this.state.scelleVo.reference.length === 8 && !this.containsScelle(this.state.scelleVo.reference)) {
            this.state.controleApresScannerVo.scelles[this.state.scelleVo.reference] = this.state.scelleVo.reference;
            this.resetScelle();
        }
    };
    ...
    removeScelle = () => {
        if (this.state.selectedScelle) {
            for (let [key, value] of Object.entries(this.state.controleApresScannerVo.scelles)) {
    ...
    generateScelles = () => {
        if (this.state.generateurDu.length === 8 && this.state.generateurAu.length === 8
            && this.state.generateurDu < this.state.generateurAu && (this.state.generateurAu - this.state.generateurDu) < 100) {
            for (let scelle = this.state.generateurDu; scelle <= this.state.generateurAu; scelle++) {
    ...
    confirmPictureRemoval = () => {
        let imageIndex = this.state.controleApresScannerVo.photosControleApresScanner.indexOf(this.state.toRemovePicture);
        if (imageIndex > -1) {
            this.state.controleApresScannerVo.photosControleApresScanner.splice(imageIndex, 1);
        }
    ...
    renderBoxItem = ({item}) => {
        const itemStyle = item === this.state.selectedScelle ? style.selectedBoxItem : style.boxItem;
        const itemTextStyle = item === this.state.selectedScelle ? style.selectedBoxItemText : style.boxItemText;
                            ...
                            <View>
                                ...
                                <Grid style={style.topMarginStyle}>
                                    ...
                                    <View style={style.topMarginStyle}>
                                        <ComAccordionComp
                                            expanded={false}
                                            title={translate('controleApresScanner.core.resultatControle.title')}>
                                            <View>
                                                <Row size={100}>
                                                    <Col size={30}>
                                                        <Row>
                                                            <Col style={style.labelContainer}>
                                                                <Text style={style.labelTextStyle}>
                                                                    {translate('controleApresScanner.core.resultatControle.commentaire')}
                                                                </Text>
                                                            </Col>
                                                    ...
                                                    <Col size={70} style={style.labelContainer}>
                                                        <TextInput
                                                            ...
                                                            numberOfLines={4}
                                                            mode="outlined"
                                                            label={translate('controleApresScanner.core.resultatControle.commentaire')}
                                                            value={this.state.controleApresScannerVo.commentaire}
                                                    ...
                                                    <HelperText
                                                        ...
                                                        {translate('errors.donneeObligatoire', {champ: translate('controleApresScanner.core.resultatControle.commentaire')})}
                                                    </HelperText>
                                                </Row>
                                                ...
                                                <Row size={100}>
                                                    <Col size={30}>
                                                        <Row>
                                                            <Col style={style.labelContainer}>
                                                                <Text style={style.labelTextStyle}>
                                                                    {translate('controleApresScanner.core.resultatControle.resultatControle')}
                                                                </Text>
                                                            </Col>
                                                    ...
                                                    <Col size={70} style={style.labelContainer}>
                                                        <ComBadrItemsPickerComp
                                                            label={translate('controleApresScanner.core.resultatControle.resultatControle')}
                                                            selectedValue={this.state.controleApresScannerVo.resultat ? this.state.controleApresScannerVo.resultat : ''}
                                    ...
                                    <View style={style.topMarginStyle}>
                                        <ComAccordionComp
                                            expanded={false}
                                            title={translate('controleApresScanner.core.scelles.title')}>
                                            <View>
                                                <Row size={100} style={style.topMarginStyle}>
                                                    <Col size={30} style={style.labelContainer}>
                                                        <Text style={style.labelTextStyle}>
                                                            {translate('controleApresScanner.core.scelles.scellesConfirmationEntree')}
                                                        </Text>
                                                    </Col>

                                                    <Col size={70} style={style.boxContainer}>
                                                        <SafeAreaView style={style.boxSafeArea}>
                                                            {(this.state.controleApresScannerVo.scellesConfirmationEntree == null || this.state.controleApresScannerVo.scellesConfirmationEntree.size === 0) && (
                                                                <Text style={style.boxItemText}>Aucun élément</Text>
                                                            )}

                                                            {(this.state.controleApresScannerVo.scellesConfirmationEntree != null && this.state.controleApresScannerVo.scellesConfirmationEntree.size !== 0) && (
                                                                <FlatList
                                                                    data={Object.values(this.state.controleApresScannerVo.scellesConfirmationEntree)}
                                                ...
                                                <Row size={100} style={style.topMarginStyle}>
                                                    <Col size={30} style={style.labelContainer}>
                                                        <Text style={style.labelTextStyle}>
                                                            {translate('controleApresScanner.core.scelles.nouveauxScelles')}
                                                        </Text>
                                                    </Col>

                                                    <Col size={3}>
                                                        <RadioButton
                                                            value={this.state.controleApresScannerVo.infoEcorScelle && this.state.controleApresScannerVo.infoEcorScelle === true ? 'true' : 'false'}
                                                            status={this.state.controleApresScannerVo.infoEcorScelle && this.state.controleApresScannerVo.infoEcorScelle === true ? 'checked' : 'unchecked'}
                                                            onPress={() => this.setState({
                                                                ...this.state,
                                                                controleApresScannerVo: {
                                                                    ...this.state.controleApresScannerVo,
                                                    ...
                                                    <Col size={10} style={style.labelContainer}>
                                                        <Text style={style.labelTextStyle}>
                                                            {translate('controleApresScanner.core.scelles.oui')}
                                                        </Text>
                                                    </Col>

                                                    <Col size={3}>
                                                        <RadioButton
                                                            value={this.state.controleApresScannerVo.infoEcorScelle === null || this.state.controleApresScannerVo.infoEcorScelle === false ? 'true' : 'false'}
                                                            status={this.state.controleApresScannerVo.infoEcorScelle === null || this.state.controleApresScannerVo.infoEcorScelle === false ? 'checked' : 'unchecked'}
                                                            onPress={() => this.setState({
                                                                ...this.state,
                                                                controleApresScannerVo: {
                                                                    ...this.state.controleApresScannerVo,
                                                    ...
                                                    <Col size={10} style={style.labelContainer}>
                                                        <Text style={style.labelTextStyle}>
                                                            {translate('controleApresScanner.core.scelles.non')}
                                                        </Text>
                                                    </Col>
                                                ...
                                                {this.state.controleApresScannerVo.infoEcorScelle && this.state.controleApresScannerVo.infoEcorScelle === true && (
                                                    <View>
                                                        <Row size={100}>
                                                            <Col size={30} style={style.labelContainer}>
                                                                <Text style={style.labelTextStyle}>
                                                                    {translate('controleApresScanner.core.scelles.numeroPince')}
                                                                </Text>
                                                            </Col>
                                                            ...
                                                            <Col size={70}>
                                                                <TextInput
                                                                    mode="outlined"
                                                                    label={translate('controleApresScanner.core.scelles.numeroPince')}
                                                                    value={this.state.controleApresScannerVo.numeroPince}
                                                        ...
                                                        <Row size={100}>
                                                            <Col size={30} style={style.labelContainer}>
                                                                <Text style={style.labelTextStyle}>
                                                                    {translate('controleApresScanner.core.scelles.nombreScelles')}
                                                                </Text>
                                                            </Col>
                                                            ...
                                                            <Col size={70}>
                                                                <TextInput
                                                                    mode="outlined"
                                                                    label={translate('controleApresScanner.core.scelles.nombreScelles')}
                                                                    value={this.state.controleApresScannerVo.nombreScelle}
                                                                    keyboardType={'number-pad'}
                                                                    maxLength={8}
                                                                    onChangeText={(text) => {
                                                                        text = text.replace(/[^0-9.]/g, '');
                                                        ...
                                                        <Row size={100}>
                                                            <Col size={30} style={style.labelContainer}>
                                                                <Text style={style.labelTextStyle}>
                                                                    {translate('controleApresScanner.core.scelles.generateurNumerosScelles')}
                                                                </Text>
                                                            </Col>

                                                            <Col size={5} style={style.labelContainer}>
                                                                <Text style={style.labelTextStyle}>
                                                                    {translate('controleApresScanner.core.scelles.du')}
                                                                </Text>
                                                            </Col>
                                                            ...
                                                            <Col size={20}>
                                                                <TextInput
                                                                    mode="outlined"
                                                                    label={translate('controleApresScanner.core.scelles.du')}
                                                            ...
                                                            <Col size={5} style={style.labelContainer}>
                                                                <Text style={style.labelTextStyle}>
                                                                    {translate('controleApresScanner.core.scelles.au')}
                                                                </Text>
                                                            </Col>
                                                            ...
                                                            <Col size={20}>
                                                                <TextInput
                                                                    mode="outlined"
                                                                    label={translate('controleApresScanner.core.scelles.au')}
                                                        ...
                                                        <Row size={100} style={style.topMarginStyle}>
                                                            <Col size={30} style={style.labelContainer}>
                                                                <Text style={style.labelTextStyle}>
                                                                    {translate('controleApresScanner.core.scelles.numeroScelle')}
                                                                </Text>
                                                            </Col>
                                                            ...
                                                            <Col size={40} style={style.boxContainer}>
                                                                <SafeAreaView style={style.boxSafeArea}>
                                                                    {(this.state.controleApresScannerVo.scelles == null || this.state.controleApresScannerVo.scelles.size === 0) && (
                                                                        <Text style={style.boxItemText}>Aucun
                                                                            élément</Text>
                                                                    )}

                                                                    {(this.state.controleApresScannerVo.scelles != null && this.state.controleApresScannerVo.scelles.size !== 0) && (
                                                                        <FlatList
                                                                            data={Object.values(this.state.controleApresScannerVo.scelles)}
                                                                            renderItem={(item) => this.renderBoxItem(item)}
                                                                            keyExtractor={item => item}
                                                                            nestedScrollEnabled={true}
                                                                        />
                                    ...
                                    <View style={style.topMarginStyle}>
                                        <ComAccordionComp
                                            expanded={false}
                                            title={translate('controleApresScanner.core.photosControle.title')}>
                                            <View>
                                                {!this.state.readonly && (
                                                    <Row size={100}>
                                                        <Col size={40}/>
                                                        ...
                                                        <Col size={20}>
                                                            <Button
                                                                title={translate('controleApresScanner.core.photosControle.addImage')}
                                                                type={'solid'}
                                                                buttonStyle={style.buttonAction}
                                                ...
                                                <Row size={100}>
                                                    <Col size={100}>
                                                        <FlatList
                                                            data={this.state.controleApresScannerVo.photosControleApresScanner}
                            ...
                            <Modal isVisible={this.state.deleteMode}
                                ...
                                <View>
                                    <Text style={style.modalMessage}>
                                        {translate('controleApresScanner.core.photosControle.removalModal.message')}
                                    </Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(CtrlControleApresScannerCoreComponent);
