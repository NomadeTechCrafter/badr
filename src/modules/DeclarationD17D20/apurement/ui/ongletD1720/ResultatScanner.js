...
import RechApurmentAction from "../../state/actions/RechApurmentAction";
import * as ApurementConstants from '../../state/ApurementConstants';


class ResultatScannerScreen extends React.Component {
    defaultState = {
        selectedDum: {},
    };
