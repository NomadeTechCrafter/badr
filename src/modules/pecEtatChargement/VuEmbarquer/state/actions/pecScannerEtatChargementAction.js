import {
    SCANNER_ETAT_CHARGEMENT_VE_FAILED,
    SCANNER_ETAT_CHARGEMENT_VE_IN_PROGRESS,
    SCANNER_ETAT_CHARGEMENT_VE_INIT,
    SCANNER_ETAT_CHARGEMENT_VE_SUCCESS,
...
export function inProgress(action) {
    return {
        type: SCANNER_ETAT_CHARGEMENT_VE_IN_PROGRESS,
        value: action.value,
    };
}
export function init(action) {
    return {
        type: SCANNER_ETAT_CHARGEMENT_VE_INIT,
        value: action.value,
    };
}
export function success(data) {
    return {
        type: SCANNER_ETAT_CHARGEMENT_VE_SUCCESS,
        value: data,
    };
}
export function failed(data) {
    return {
        type: SCANNER_ETAT_CHARGEMENT_VE_FAILED,
        value: data,
    };
}
export default {
