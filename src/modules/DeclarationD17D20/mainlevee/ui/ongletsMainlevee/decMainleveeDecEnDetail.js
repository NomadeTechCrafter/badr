...
class MainleveeDecEnDetail extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...initialState,
    ...
    return [
      {
        ...
        libelle: translate('mainlevee.decEnDetail.ref'),
        width: 160,
      },
      {
        code: 'dedServicesVO.operateurDeclarant',
        libelle: translate('mainlevee.decEnDetail.operateur'),
        width: 160,
      },
      {
      ...
      },
      {
        ...
        libelle: translate('mainlevee.decEnDetail.nbreContenant'),
        width: 150,
      },
      {
        code: 'dedServicesVO.poidsBruts',
        libelle: translate('mainlevee.decEnDetail.poidsBrut'),
        width: 100,
      },
      {
        code: 'dedServicesVO.poidsNet',
        libelle: translate('mainlevee.decEnDetail.poidsNet'),
        width: 100,
      },
      {
        code: 'dedServicesVO.valeurDeclaree',
        libelle: translate('mainlevee.decEnDetail.valDeclaree'),
        width: 100,
      },
    ];
  };
  ...
  render() {
    ...
    const listDeclarationEnDouaneVO = this.props.dataVo?.listDeclarationEnDouaneVO;
