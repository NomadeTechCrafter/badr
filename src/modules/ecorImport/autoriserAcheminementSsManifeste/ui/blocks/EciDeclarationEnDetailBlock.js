        ...
        <ComAccordionComp
          ...
          <Grid>
            <Row style={CustomStyleSheet.lightBlueRow}>
              ...
              <Col>
                <ComBadrLibelleComp>
                  {autoriserAcheminementVO.refDedServices.dateEnregistrement}
                </ComBadrLibelleComp>
              </Col>
              <Col>
                <ComBadrLibelleComp>
              ...
              <Col>
                <ComBadrLibelleComp>
                  {autoriserAcheminementVO.refDedServices.poidsBruts}
                </ComBadrLibelleComp>
              </Col>
            </Row>
            <Row style={CustomStyleSheet.whiteRow}>
              ...
              <Col>
                <ComBadrLibelleComp>
                  {autoriserAcheminementVO.refDedServices.libelleTypeDED}
                </ComBadrLibelleComp>
              </Col>
              <Col>
                <ComBadrLibelleComp>
              ...
              <Col>
                <ComBadrLibelleComp>
                  {autoriserAcheminementVO.refDedServices.poidsNet}
                </ComBadrLibelleComp>
              </Col>
            </Row>
            <Row style={CustomStyleSheet.lightBlueRow}>
              ...
              <Col>
                <ComBadrLibelleComp>
                  {autoriserAcheminementVO.refDedServices.operateurDeclarant}
                </ComBadrLibelleComp>
              </Col>
              <Col>
                <ComBadrLibelleComp>
              ...
              <Col>
                <ComBadrLibelleComp>
                  {autoriserAcheminementVO.refDedServices.nombreContenants}
                </ComBadrLibelleComp>
              </Col>
            </Row>
            <Row style={CustomStyleSheet.whiteRow}>
              ...
              <Col size={1}>
                <ComBadrLibelleComp>
                  {autoriserAcheminementVO.refDedServices.valeurDeclaree}
                </ComBadrLibelleComp>
              </Col>
              <Col size={2} />
            </Row>
