import * as Constants from '../controleRegimeInterneConstants';
...
export default (state = initialState, action) => {
  ...
  switch (action.type) {
    ...
    case Constants.REGIMEINTERNE_GENERERCR_REQUEST:
      ...
      return nextState;
    case Constants.REGIMEINTERNE_GENERERCR_IN_PROGRESS:
      console.log('--> GENERERCR in progress...');
      return nextState;
    case Constants.REGIMEINTERNE_GENERERCR_SUCCESS:
