...
class ModifierCompteRenduMission extends React.Component {
        ...
        return (
            <View style={style.container}>
                <ComBadrToolbarComp
                    ...
                    icon="menu"
                    title={translate('enquetes.compteRenduMission.modifierCompteRenduMission.title')}
                />

                {(this.props.searchMode) && (
                    <EnqCompteRenduSearchComponent navigation={this.props.navigation} mode={'edit'}/>
                )}

                {this.props.detailMode && (
                    <EnqCompteRenduCoreComponent navigation={this.props.navigation} mode={'edit'}
