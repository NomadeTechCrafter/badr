        ...
        return (
            <View style={style.container}>
                <ComBadrToolbarComp
                    ...
                    icon="menu"
                    title={translate('referentiel.operateursEconomiques.debloquerOperateur.title')}
                />

                {this.props.searchMode && (
                    <RefOperateursEconomiquesSearchComponent navigation={this.props.navigation} includeInvalid={false} onAction={this.debloquer}/>
                )}
            </View>
        );
    };
