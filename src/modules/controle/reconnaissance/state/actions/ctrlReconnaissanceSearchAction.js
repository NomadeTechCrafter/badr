...
export function request(action, navigation) {
    return (dispatch) => {
        ...
        CtrlReconnaissanceApi.lookupReconnaissances(action.value)
            .then((response) => {
                if (response) {
...
export function inProgress(action) {
    return {
        type: Constants.SEARCH_RECONNAISSANCE_IN_PROGRESS,
        value: action.value,
    };
}
...
export function success(data) {
    return {
        type: Constants.SEARCH_RECONNAISSANCE_SUCCESS,
        value: data.jsonVO,
    };
}
...
export function failed(data) {
    return {
        type: Constants.SEARCH_RECONNAISSANCE_FAILED,
        value: data,
    };
}
