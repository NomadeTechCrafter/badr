...
class ActifsRapportProprietairesSousBlock extends React.Component {
    ...
    render() {
        console.log("ActifsRapportProprietairesSousBlock this.props", this.props);
        return (
            ...
            <View>
                <View>
                    <Row style={CustomStyleSheet.lightBlueRow}>
                        ...
                        <Col size={2}>
                            <ComBadrLibelleComp withColor={true}>
                                {translate('actifsCreation.avionsPrivees.proprietaires.idOuRc')}
                            </ComBadrLibelleComp>
                        </Col>
                        <Col size={4}>
                            <ComBadrLibelleComp withColor={true}>
                                {translate('actifsCreation.avionsPrivees.proprietaires.nomPrenomOuRS')}
                            </ComBadrLibelleComp>
                        </Col>
                        <Col size={2}>
                            <ComBadrLibelleComp withColor={true}>
                                {translate('actifsCreation.avionsPrivees.proprietaires.adresse')}
                            </ComBadrLibelleComp>
                        </Col>
                        {(!this.props.readOnly) && (<Col size={2}>
                            <ComBadrLibelleComp withColor={true}>
                                {translate('actifsCreation.avionsPrivees.proprietaires.actions')}
                            </ComBadrLibelleComp>
                        </Col>)}
                    </Row>
