...
class ReferenceTabSearchComponent extends React.Component {
  ...
  onChangeSearchInput = (searchInput, isNumeric) => {
    ...
    this.setState({
      [inputKey]: isNumeric
        ? searchInput[inputKey].replace(/[^0-9]/g, '')
        : searchInput[inputKey].replace(/[^A-Za-z]/g, '').toUpperCase(),
    });
  };
  ...
  hasInvalidCleDum = () => {
    return (
      ...
      !_.isEmpty(this.state.validCleDum) &&
      this.state.cle !== this.state.validCleDum
    );
  };
          ...
          <Grid>
            <Row>
              <Col style={style.searchInputContainer}>
                <TextInput
                  label={translate(
                    'controleApresScanner.search.declarationEnDetail.bureau',
                  )}
                  value={this.state.bureau}
                  keyboardType={'number-pad'}
                  maxLength={3}
                  onChangeText={(val) =>
                    this.onChangeSearchInput({bureau: val}, true)
                  }
                  onEndEditing={(event) =>
                    this.completeWithZeros({
            ...
            <Row>
              <Col style={style.searchInputContainer}>
                <TextInput
                  label={translate(
                    'controleApresScanner.search.declarationEnDetail.regime',
                  )}
                  value={this.state.regime}
                  keyboardType={'number-pad'}
                  maxLength={3}
                  onChangeText={(val) =>
                    this.onChangeSearchInput({regime: val}, true)
                  }
                  onEndEditing={(event) =>
                    this.completeWithZeros({
            ...
            <Row>
              <Col style={style.searchInputContainer}>
                <TextInput
                  label={translate(
                    'controleApresScanner.search.declarationEnDetail.annee',
                  )}
                  value={this.state.annee}
                  keyboardType={'number-pad'}
                  maxLength={4}
                  onChangeText={(val) =>
                    this.onChangeSearchInput({annee: val}, true)
                  }
                  onEndEditing={(event) =>
                    this.completeWithZeros({
            ...
            <Row>
              <Col style={style.searchInputContainer}>
                <TextInput
                  label={translate(
                    'controleApresScanner.search.declarationEnDetail.serie',
                  )}
                  value={this.state.serie}
                  keyboardType={'number-pad'}
                  maxLength={7}
                  onChangeText={(val) =>
                    this.onChangeSearchInput({serie: val}, true)
                  }
                  onEndEditing={(event) =>
                    this.completeWithZeros({
            ...
            <Row>
              <Col style={style.searchInputContainer}>
                <TextInput
                  label={translate(
                    'controleApresScanner.search.declarationEnDetail.cle',
                  )}
                  value={this.state.cle}
                  // keyboardType={''}
                  maxLength={1}
                  onChangeText={(val) =>
                    this.onChangeSearchInput({cle: val}, false)
                  }
                  style={style.searchInput}
                />
            ...
            <Row>
              <Col style={style.searchInputContainer}>
                <TextInput
                  ...
                  maxLength={1}
                  onChangeText={(val) =>
                    this.onChangeSearchInput({numeroVoyage: val}, true)
                  }
                  style={style.searchInput}
                />
