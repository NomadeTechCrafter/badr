...
import { ComAccordionComp, ComBadrAutoCompleteChipsComp, ComBadrButtonComp, ComBadrErrorMessageComp, ComBadrPickerComp } from '../../../../../../../commons/component';
...
class T6bisArticlesCurrentArticleMtmBlock extends React.Component {
    ...
    checkRequiredFields = () => {
        ...
        if (_.isEmpty(this.state.currentArticle.natureMarchandise)) {
            required = true;
            msg += translate('t6bisGestion.tabs.articles.articleBlock.mtm.natureMarchandise');
        }

        if (_.isEmpty(this.state.currentArticle.designation)) {
            required = true;
            msg += !_.isEmpty(msg) ? "," : "";
            msg += translate('t6bisGestion.tabs.articles.articleBlock.mtm.designation');
        }
        if (_.isEmpty(this.state.currentArticle.valeurTaxable)) {
            required = true;
            msg += !_.isEmpty(msg) ? "," : "";
            msg += translate('t6bisGestion.tabs.articles.articleBlock.mtm.valeurTaxable');
        }
        if (_.isEmpty(this.state.currentArticle.montantFacture)) {
            required = true;
            msg += !_.isEmpty(msg) ? "," : "";
            msg += translate('t6bisGestion.tabs.articles.articleBlock.mtm.montantFacture');
        }
        ...
        if (required) {
            msg = translate('t6bisGestion.tabs.articles.articleBlock.mtm.champsObligatoires') + msg;
            this.setState({
                errorMessage: msg
            });
        } else {
    ...
    render() {
        return (
            ...
            <ComAccordionComp title={translate('t6bisGestion.tabs.articles.articleBlock.mtm.title') + this.state.currentArticle?.numArticle} expanded={true}>
                ...
                <View>
                    ...
                    <Row size={200}>
                        <Col size={40} style={styles.labelContainer}>
                            <Text style={styles.labelTextStyle}>
                                {translate('t6bisGestion.tabs.articles.articleBlock.mtm.codeNomenclature')}
                            </Text>
                        ...
                        <Col size={40} style={styles.labelContainer}>
                            <Text style={styles.labelTextStyle}>
                                {translate('t6bisGestion.tabs.articles.articleBlock.mtm.natureMarchandise')}
                            </Text>
                            <HelperText
                                type="error"
                                padding="none"
                    ...
                    <Row size={200}>
                        <Col size={40} style={styles.labelContainer}>
                            <Text style={styles.labelTextStyle}>
                                {translate('t6bisGestion.tabs.articles.articleBlock.mtm.designation')}
                            </Text>
                            <HelperText
                                type="error"
                                padding="none"
                    ...
                    <Row size={200}>
                        <Col size={40} style={styles.labelContainer}>
                            <Text style={styles.labelTextStyle}>
                                {translate('t6bisGestion.tabs.articles.articleBlock.mtm.valeurTaxable')}
                            </Text>
                            <HelperText
                                type="error"
                                padding="none"
                    ...
                    <Row size={200}>
                        <Col size={40} style={styles.labelContainer}>
                            <Text style={styles.labelTextStyle}>
                                {translate('t6bisGestion.tabs.articles.articleBlock.mtm.montantFacture')}
                            </Text>
                            <HelperText
                                type="error"
                                padding="none"
                        ...
                        <Col size={40} style={styles.labelContainer}>
                            <Text style={styles.labelTextStyle}>
                                {translate('t6bisGestion.tabs.articles.articleBlock.mtm.devise')}
                            </Text>
                            <HelperText
                                type="error"
                                padding="none"
                    ...
                    <Row size={200}>
                        <Col size={40} style={styles.labelContainer}>
                            <Text style={styles.labelTextStyle}>
                                {translate('t6bisGestion.tabs.articles.articleBlock.mtm.quantite')}
                            </Text>
                            <HelperText
                                type="error"
                                padding="none"
                        ...
                        <Col size={200}>
                            ...
                            <View style={styles.ComContainerCompBtn}>
                                ...
                                <ComBadrButtonComp
                                    ...
                                    text={translate('t6bisGestion.tabs.articles.articleBlock.buttons.nouveau')}
                                />
                            </View>
                        </Col>
                    </Row>)}
