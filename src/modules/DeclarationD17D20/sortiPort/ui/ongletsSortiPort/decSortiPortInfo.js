...
class SortiPortInfo extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...initialState,
    ...
    return [
      {
        ...
        libelle: translate('sortiPort.historique.date'),
        width: 160,
      },
      {
        code: 'numeroVersion',
        libelle: translate('sortiPort.historique.version'),
        width: 60,
      },
      {
        code: 'intervention',
        libelle: translate('sortiPort.historique.intervention'),
        width: 200,
      },
      {
        code: 'refEtatResultat',
        libelle: translate('sortiPort.historique.etatResult'),
        width: 200,
      },
      {
        code: 'codeActeur',
        libelle: translate('sortiPort.historique.user'),
        width: 150,
      },
      {
        code: 'commentaireIntervention',
        libelle: translate('sortiPort.historique.comment'),
        width: 300,
      },
    ];
  };
      ...
      <View style={styles.fabContainer}>
        <ScrollView>
          ...
          <CardBox style={styles.cardBox}>
            <Accordion badr title={translate('sortiPort.versions.title')}>
...
export default connect(mapStateToProps, mapDispatchToProps)(SortiPortInfo);
