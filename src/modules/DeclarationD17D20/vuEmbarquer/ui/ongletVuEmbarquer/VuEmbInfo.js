...
class VuEmbarquerInfo extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...initialState,
    ...
    return [
      {
        ...
        libelle: translate('vuEmbarquee.historique.date'),
        width: 160,
      },
      {
        code: 'numeroVersion',
        libelle: translate('vuEmbarquee.historique.version'),
        width: 60,
      },
      {
        code: 'intervention',
        libelle: translate('vuEmbarquee.historique.intervention'),
        width: 200,
      },
      {
        code: 'refEtatResultat',
        libelle: translate('vuEmbarquee.historique.etatResult'),
        width: 200,
      },
      {
        code: 'codeActeur',
        libelle: translate('vuEmbarquee.historique.user'),
        width: 150,
      },
      {
        code: 'commentaireIntervention',
        libelle: translate('vuEmbarquee.historique.comment'),
        width: 300,
      },
    ];
  };
                      ...
                      <DataTable style={styles.table}>
                        <DataTable.Header style={styles.tableHeader}>
                          <DataTable.Title style={{width: 60}}>
                            <Text style={styles.libelle}>
                              {translate('vuEmbarquee.versions.num')}
                            </Text>
                          </DataTable.Title>
                          <DataTable.Title style={{width: 150}}>
                            <Text style={styles.libelle}>
                              {translate('vuEmbarquee.versions.type')}
                            </Text>
                          </DataTable.Title>
                          <DataTable.Title style={{width: 150}}>
                            <Text style={styles.libelle}>
                              {translate('vuEmbarquee.versions.statut')}
                            </Text>
                          </DataTable.Title>
                          <DataTable.Title style={{width: 200}}>
                            <Text style={styles.libelle}>
                              {translate('vuEmbarquee.versions.dateCreation')}
                            </Text>
                          </DataTable.Title>
                          <DataTable.Title style={{width: 200}}>
                            <Text style={styles.libelle}>
                              {translate('vuEmbarquee.versions.dateSignature')}
                            </Text>
                          </DataTable.Title>
                        </DataTable.Header>
                        {listeVersions ? (
...
export default connect(mapStateToProps, mapDispatchToProps)(VuEmbarquerInfo);
