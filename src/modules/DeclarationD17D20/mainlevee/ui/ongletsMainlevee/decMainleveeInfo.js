...
class MainleveeInfo extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...initialState,
    ...
    return [
      {
        ...
        libelle: translate('mainlevee.historique.date'),
        width: 160,
      },
      {
        code: 'numeroVersion',
        libelle: translate('mainlevee.historique.version'),
        width: 60,
      },
      {
        code: 'intervention',
        libelle: translate('mainlevee.historique.intervention'),
        width: 200,
      },
      {
        code: 'refEtatResultat',
        libelle: translate('mainlevee.historique.etatResult'),
        width: 200,
      },
      {
        code: 'codeActeur',
        libelle: translate('mainlevee.historique.user'),
        width: 150,
      },
      {
        code: 'commentaireIntervention',
        libelle: translate('mainlevee.historique.comment'),
        width: 300,
      },
    ];
  };
      ...
      <View style={styles.fabContainer}>
        <ScrollView>
          ...
          <CardBox style={styles.cardBox}>
            <Accordion badr title={translate('mainlevee.versions.title')}>
                      ...
                      <DataTable style={styles.table}>
                        <DataTable.Header style={styles.tableHeader}>
                          <DataTable.Title style={{ width: 60 }}>
                            <Text style={styles.libelle}>
                              {translate('mainlevee.versions.num')}
                            </Text>
                          </DataTable.Title>
                          <DataTable.Title style={{ width: 150 }}>
                            <Text style={styles.libelle}>
                              {translate('mainlevee.versions.type')}
                            </Text>
                          </DataTable.Title>
                          <DataTable.Title style={{ width: 150 }}>
                            <Text style={styles.libelle}>
                              {translate('mainlevee.versions.statut')}
                            </Text>
                          </DataTable.Title>
                          <DataTable.Title style={{ width: 200 }}>
                            <Text style={styles.libelle}>
                              {translate('mainlevee.versions.dateCreation')}
                            </Text>
                          </DataTable.Title>
                          <DataTable.Title style={{ width: 200 }}>
                            <Text style={styles.libelle}>
                              {translate('mainlevee.versions.dateSignature')}
                            </Text>
                          </DataTable.Title>
                        </DataTable.Header>
                        {listeVersions ? (
          ...
          <CardBox style={styles.cardBox}>
            <Accordion
              badr
              title={translate('mainlevee.historique.title')}
              expanded>
              <Text style={styles.nombreResult}>
                {translate('mainlevee.versions.nbreVersions')} :
                <Text style={styles.libelle}>
...
export default connect(mapStateToProps, mapDispatchToProps)(MainleveeInfo);
