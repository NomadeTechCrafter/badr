  ...
  buildComposantsColumns = (actions) => {
    return [
      ...
      },
      {
        ...
        libelle: translate('annoter.etatChargement.dateVoyage'),
        width: 150,
      },
      {
        code: 'etatChargement.refDeclarant',
        libelle: translate('annoter.etatChargement.declarant'),
        width: 100,
      },
      {
        code: 'etatChargement.bureauSortie',
        libelle: translate('annoter.etatChargement.bureauSortie'),
        width: 100,
      },
      {
        code: 'etatChargement.navire',
        libelle: translate('annoter.etatChargement.navire'),
        width: 100,
      },
    ];
  };
...
export default connect(null, mapDispatchToProps)(RechParRefApurement);
