...
export function inProgress(action) {
  return {
    type: Constants.SCANNER_D17_MAINLEVEE_IN_PROGRESS,
    value: action.value,
  };
}
...
export function init() {
  return {
    type: Constants.SCANNER_D17_MAINLEVEE_INIT,
    value: action.value,
  };
}
...
export function success(data) {
  return {
    type: Constants.SCANNER_D17_MAINLEVEE_SUCCESS,
    value: data,
  };
}
...
export function failed(data) {
  return {
    type: Constants.SCANNER_D17_MAINLEVEE_FAILED,
    value: data,
  };
}
