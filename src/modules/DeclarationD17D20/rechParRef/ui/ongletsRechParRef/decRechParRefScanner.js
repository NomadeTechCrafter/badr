...
import style from '../../style/decRechParRefStyle';
...
import * as RechParRefScanAction from '../../state/actions/decRechParRefScanAction';
...
class RechParRefScanner extends React.Component {
    ...
    constructor(props) {
        ...
        this.cols = [
            {
                code: 'dateScannage',
                libelle: translate('rechParRef.scanner.dateScannage'),
                width: 200,
            },
            {
                code: 'agent',
                libelle: translate('rechParRef.scanner.agent'),
                width: 150,
            },
            {
                code: 'resultat',
                libelle: translate('rechParRef.scanner.resultat'),
                width: 250,
            },
            {
                code: 'commentaire',
                libelle: translate('rechParRef.scanner.commentaire'),
                width: 300,
            }
        ];
    }
