        ...
        return (
            <View style={style.container}>
                <ComBadrToolbarComp
                    ...
                    icon="menu"
                    title={translate('referentiel.operateursEconomiques.bloquerOperateur.title')}
                />
                ...
                <NavigationContainer independent={true}>
                    <Tab.Navigator
                        ...
                        <Tab.Screen name={translate('referentiel.operateursEconomiques.bloquerOperateur.tabs.ajouter')}
                                    component={AddScreen}/>
                        <Tab.Screen name={translate('referentiel.operateursEconomiques.bloquerOperateur.tabs.modifier')}
                                    component={EditScreen}/>
                        <Tab.Screen name={translate('referentiel.operateursEconomiques.bloquerOperateur.tabs.services')}
