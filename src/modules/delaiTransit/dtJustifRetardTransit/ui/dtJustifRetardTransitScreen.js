...
import {TYPE_SERVICE_UC, MODULE_ECOREXP} from '../../../../commons/Config';
    ...
    return (
      <View>
        ...
        {this.props.data?.dtoHeader?.messagesInfo && (
          <ComBadrInfoMessageComp
            message={this.props.data?.dtoHeader?.messagesInfo}
          />
        )}
        {this.props.data?.dtoHeader?.messagesErreur && (
          <ComBadrErrorMessageComp
            message={this.props.data?.dtoHeader?.messagesErreur}
          />
        )}
...
export default connect(mapStateToProps, null)(JustifRetardTransitMainScreen);
