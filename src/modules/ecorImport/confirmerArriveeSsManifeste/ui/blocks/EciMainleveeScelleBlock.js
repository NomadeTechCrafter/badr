      ...
      <ComBadrCardBoxComp noPadding={true}>
        ...
        <ComAccordionComp
          ...
          <Grid>
            <Row style={CustomStyleSheet.whiteRow}>
              ...
              <Col size={4}>
                <View style={styles.flexRow}>
                  <RadioButton.Group
                    value={
                      confirmerArriveeVO?.refMainlevee?.infoEcorScelle ===
                      true
                        ? 'true'
                        : 'false'
                    }>
            ...
            {confirmerArriveeVO?.refMainlevee?.infoEcorScelle == true && (
              <View>
                <Row style={CustomStyleSheet.whiteRow}>
                  <Col size={1}>
                    <TextInput
                      mode={'outlined'}
                      maxLength={8}
                      value={confirmerArriveeVO?.refMainlevee?.numeroPince}
                  ...
                  <Col size={1}>
                    <ComBadrNumericTextInputComp
                      maxLength={8}
                      value={
                        confirmerArriveeVO?.refMainlevee?.nombreDeScelles
                      }
                ...
                <Row
                  ...
                  <Col size={4} style={styles.boxContainer}>
                    <SafeAreaView style={styles.boxSafeArea}>
                      {_.isEmpty(
                        Object.values(
                          confirmerArriveeVO?.refMainlevee?.listScelle,
                        ),
                      ) && (
