...
import style from '../../style/decAnnoterStyle';
...
import * as RechParRefScanAction from '../../state/actions/decAnnoterScanAction';
import * as Constants from '../../state/decAnnoterConstants';

class RechParRefScanner extends React.Component {
  defaultState = {
    selectedDum: {},
  };
  ...
  constructor(props) {
    ...
    this.cols = [
      {
        code: 'dateScannage',
        libelle: translate('annoter.scanner.dateScannage'),
        width: 200,
      },
      {
        code: 'agent',
        libelle: translate('annoter.scanner.agent'),
        width: 150,
      },
      {
        code: 'resultat',
        libelle: translate('annoter.scanner.resultat'),
        width: 250,
      },
      {
        code: 'commentaire',
  ...
  componentDidMount() {
    var action = RechParRefScanAction.request(
      {
        ...
        value: {
          ...
          module: 'AEC_LIB',
          typeService: 'SP',
          data: this.props.dataVo?.declarationTriptique
      ...
      <View style={style.mainContainer}>
        <ScrollView>
          ...
          <CardBox style={style.cardBox}>
            <Accordion badr title={translate('tabs.resultScanner')}>
              {/* {resultatsScanner && ( */}
              <ComBasicDataTableComp
                ref="_badrTable"
                id="scannerTable"
...
function mapStateToProps(state) {
  return {...state.rechParRefInitReducer};
}
...
export default connect(mapStateToProps, mapDispatchToProps)(RechParRefScanner);
