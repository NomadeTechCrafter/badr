...
class SortiPortDecEnDetail extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...initialState,
  ...
  buildComposantsColumns = (actions) => {
    return [
      ...
      },
      {
        ...
        libelle: translate('sortiPort.decEnDetail.operateur'),
        width: 160,
      },
      {
        code: 'formatedDateenregistrement',
        libelle: translate('sortiPort.dateEnregistrement'),
        width: 200,
      },
      {
        code: 'dedServicesVO.nombreContenants',
        libelle: translate('sortiPort.decEnDetail.nbreContenant'),
        width: 150,
      },
      {
        code: 'dedServicesVO.poidsBruts',
        libelle: translate('sortiPort.decEnDetail.poidsBrut'),
        width: 100,
      },
      {
        code: 'dedServicesVO.poidsNet',
        libelle: translate('sortiPort.decEnDetail.poidsNet'),
        width: 100,
      },
      {
        code: 'dedServicesVO.valeurDeclaree',
        libelle: translate('sortiPort.decEnDetail.valDeclaree'),
        width: 100,
      },
    ];
  };
