    ...
    return [
      {
        ...
        libelle: translate('rechParRef.historique.date'),
        width: 160,
      },
      {
        code: 'numeroVersion',
        libelle: translate('rechParRef.historique.version'),
        width: 60,
      },
      {
        code: 'intervention',
        libelle: translate('rechParRef.historique.intervention'),
        width: 200,
      },
      {
        code: 'refEtatResultat',
        libelle: translate('rechParRef.historique.etatResult'),
        width: 200,
      },
      {
        code: 'codeActeur',
        libelle: translate('rechParRef.historique.user'),
        width: 150,
      },
      {
        code: 'commentaireIntervention',
        libelle: translate('rechParRef.historique.comment'),
        width: 300,
      },
    ];
  };
      ...
      <View style={styles.fabContainer}>
        <ScrollView>
          ...
          <CardBox style={styles.cardBox}>
            <Accordion badr title={translate('rechParRef.versions.title')}>
                      ...
                      <DataTable style={styles.table}>
                        <DataTable.Header style={styles.tableHeader}>
                          <DataTable.Title style={{ width: 60 }}>
                            <Text style={styles.libelle}>
                              {translate('rechParRef.versions.num')}
                            </Text>
                          </DataTable.Title>
                          <DataTable.Title style={{ width: 150 }}>
                            <Text style={styles.libelle}>
                              {translate('rechParRef.versions.type')}
                            </Text>
                          </DataTable.Title>
                          <DataTable.Title style={{ width: 150 }}>
                            <Text style={styles.libelle}>
                              {translate('rechParRef.versions.statut')}
                            </Text>
                          </DataTable.Title>
                          <DataTable.Title style={{ width: 200 }}>
                            <Text style={styles.libelle}>
                              {translate('rechParRef.versions.dateCreation')}
                            </Text>
                          </DataTable.Title>
                          <DataTable.Title style={{ width: 200 }}>
                            <Text style={styles.libelle}>
                              {translate('rechParRef.versions.dateSignature')}
                            </Text>
                          </DataTable.Title>
                        </DataTable.Header>
                        {listeVersions ? (
